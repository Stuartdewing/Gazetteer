...
//Marker for user location
					var youAreHere = L.icon({
						iconUrl: 'lib/img/homeMarker.svg',
						iconSize:     [25, 25],
						iconAnchor:   [22, 94],
					});
...
$.homeButton =L.easyButton('<img src="lib/img/home.svg" width="40vh" height="40vh">', function(btn, map){
			$home = [lat,lng];
			map.setView($home);
}).addTo( $.mymap );
...
$.standardMap = L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png');
	

// Wiki Button
L.easyButton('<img src="lib/img/icon.svg"" width="40vh" height="40vh">', function(){
	function newTab() {
